/*Project on Information Retrieval and Organization using Data Structures

Data structures used: Hashmaps , Linked lists and arrays.
*/
...
typedef struct
{
	char keydata [50];
	char *data;
	struct hash *p ;//lin each key:value pair
}hash;
...
char d[15][1000]; //variable to sotre data of each key

int pos , n=10 ;

char keychar[15][50] = {{"APP"},{"APPLE"},{"BADMINTON"},{"BASEBALL"},{"BASKETBALL"},{"CHESS"},{"CRICKET"},{"FOOTBALL"},{"HOCKEY"},{"MANGO"}};
...
void writeData()
{
	...
	//Entering data 2
	char k1[50] = "APPLE";
	strcpy(d[1] ,"Apple, (Malus domestica), domesticated tree and fruit of the rose family (Rosaceae), one of the most widely cultivated tree fruits. Apples are predominantly grown for sale as fresh fruit, though apples are also used commercially for vinegar, juice, jelly, applesauce, and apple butter and are canned as pie stock.") ;
	...
	//Entering data 1
	char k2[50] = "APP";
	strcpy(d[0] , "Apps are a significant part of the technology-driven world we live in and can enhance a person's life, enjoyment and productivity. Apps are also regularly used by companies both large and small to streamline production and increase ease of work.") ;
...
void main()
{
	...
	//Asking user if the wish to continue
